...
(async function run(){
 ...
 assert.equal(targets.find((t)=>t.id==='restarbeiten.main').level, 1);
 assert.equal(targets.find((t)=>t.id==='restarbeiten.filterleiste').level, 2);
 assert.equal(targets.find((t)=>t.id==='restarbeiten.liste').level, 2);
 assert.equal(targets.find((t)=>t.id==='restarbeiten.editbox').level, 1);
 assert.equal(targets.find((t)=>t.id==='restarbeiten.editbox.kurztext').level, 2);
 assert.equal(targets.find((t)=>t.id==='restarbeiten.editbox.kurztext.label').level, 3);
