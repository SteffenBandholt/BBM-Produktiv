...
const M64_TEST_ELEMENTS = Object.freeze([
  ...
  Object.freeze({ elementId: "bbm.uiEditorTest.card.button", type: "action", role: "visual-control", label: "Beispielbutton", parentId: "bbm.uiEditorTest.card", editable: true, allowedOps: Object.freeze(["move", "resize"]), lockedOps: Object.freeze(["execute", "delete"]), layoutDefaults: Object.freeze({ visible: true, minWidth: 80, minHeight: 24 }), sourceRef: "src/renderer/ui-editor/BbmUiEditorStatusPanel.js", scope: BBM_UI_SCOPE, layoutScope: BBM_LAYOUT_SCOPE, layoutProfileId: BBM_LAYOUT_PROFILE_ID, capabilities: Object.freeze(["select", "layout"]), allowedChanges: ALLOWED_LAYOUT_OPS }),
  Object.freeze({ elementId: "bbm.uiEditorTest.card.input", type: "field", role: "input", label: "Eingabefeld", parentId: "bbm.uiEditorTest.card", editable: true, allowedOps: Object.freeze(["move", "resize"]), lockedOps: Object.freeze(["write", "submit", "delete"]), layoutDefaults: Object.freeze({ visible: true, minWidth: 80, minHeight: 24 }), sourceRef: "src/renderer/ui-editor/BbmUiEditorStatusPanel.js", scope: BBM_UI_SCOPE, layoutScope: BBM_LAYOUT_SCOPE, layoutProfileId: BBM_LAYOUT_PROFILE_ID, capabilities: Object.freeze(["select", "layout"]), allowedChanges: ALLOWED_LAYOUT_OPS }),
  ...
  Object.freeze({ elementId: "bbm.uiEditorTest.table", type: "table", role: "content-table", label: "Beispieltabelle", parentId: "bbm.uiEditorTest.workspace", editable: true, allowedOps: Object.freeze(["move", "resize"]), lockedOps: Object.freeze(["edit-data", "delete"]), layoutDefaults: Object.freeze({ visible: true, minWidth: 160, minHeight: 80 }), sourceRef: "src/renderer/ui-editor/BbmUiEditorStatusPanel.js", scope: BBM_UI_SCOPE, layoutScope: BBM_LAYOUT_SCOPE, layoutProfileId: BBM_LAYOUT_PROFILE_ID, capabilities: Object.freeze(["select", "layout"]), allowedChanges: ALLOWED_LAYOUT_OPS }),
]);
