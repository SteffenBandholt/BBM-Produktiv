...
export function injectBbmUiEditorStatusPanelStyles() {
  ...
  style.textContent = `
    ...
    .bbm-ui-editor-panel__actions, .bbm-ui-editor-session-controls { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 12px; }
    .bbm-ui-editor-session-controls { display: grid; grid-template-columns: 1fr; margin-top: 0; margin-bottom: 12px; }
