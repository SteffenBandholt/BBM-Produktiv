...
const ACCEPTANCE_TOPS = Object.freeze([
  ...
  Object.freeze({ key: "root-wichtig", parentKey: null, title: "Wichtige Kennzeichnung ohne Flag", status: "offen", dueDate: "2026-10-09", longtext: "Diese neutrale Zeile prueft ausschliesslich den roten Titeltext.", important: true, task: false, decision: false, responsibleIndex: 1 }),
  Object.freeze({ key: "root-ausblick", parentKey: null, title: "Ausblick und naechste Schritte", status: "offen", dueDate: "2026-10-09", longtext: "Der Abschlussbereich enthaelt einen kurzen Ausblick auf die naechste neutrale Besprechung.", important: false, task: true, decision: false, responsibleIndex: 1 }),
  Object.freeze({ key: "root-kombiniert", parentKey: null, title: "Beschluss mit Aufgabe", status: "offen", dueDate: "2026-10-16", longtext: "Diese neutrale Zeile prueft Beschluss und ToDo im gemeinsamen rechten Flag-Bereich.", important: false, task: true, decision: true, responsibleIndex: 1 }),
  Object.freeze({ key: "fach-a-titel", parentKey: null, title: "A Titel - keine Kennzeichnung", status: "-", dueDate: null, longtext: "Fachfall A fuer die unabhaengigen Kennzeichnungen.", important: false, task: false, decision: false, responsibleIndex: 1 }),
  Object.freeze({ key: "fach-a-top", parentKey: "fach-a-titel", title: "A TOP - keine Kennzeichnung", status: "-", dueDate: null, longtext: "Fachfall A fuer einen normalen TOP.", important: false, task: false, decision: false, responsibleIndex: 1 }),
  Object.freeze({ key: "fach-b-titel", parentKey: null, title: "B Titel - keine Ampel (Titelregel)", status: "blockiert", dueDate: null, longtext: "Fachfall B belegt, dass die globale Ampel bei Level-1-Titeln nicht dargestellt wird.", important: false, task: false, decision: false, responsibleIndex: 2 }),
  Object.freeze({ key: "fach-b-top", parentKey: "fach-b-titel", title: "B TOP - nur Ampel", status: "blockiert", dueDate: null, longtext: "Fachfall B fuer einen normalen TOP.", important: false, task: false, decision: false, responsibleIndex: 2 }),
  Object.freeze({ key: "fach-c-titel", parentKey: null, title: "C Titel - nur Beschluss", status: "-", dueDate: null, longtext: "Fachfall C fuer die unabhaengigen Kennzeichnungen.", important: false, task: false, decision: true, responsibleIndex: 3 }),
  Object.freeze({ key: "fach-c-top", parentKey: "fach-c-titel", title: "C TOP - nur Beschluss", status: "-", dueDate: null, longtext: "Fachfall C fuer einen normalen TOP.", important: false, task: false, decision: true, responsibleIndex: 3 }),
  Object.freeze({ key: "fach-d-titel", parentKey: null, title: "D Titel - nur ToDo", status: "-", dueDate: null, longtext: "Fachfall D fuer die unabhaengigen Kennzeichnungen.", important: false, task: true, decision: false, responsibleIndex: 4 }),
  Object.freeze({ key: "fach-d-top", parentKey: "fach-d-titel", title: "D TOP - nur ToDo", status: "-", dueDate: null, longtext: "Fachfall D fuer einen normalen TOP.", important: false, task: true, decision: false, responsibleIndex: 4 }),
  Object.freeze({ key: "fach-e-titel", parentKey: null, title: "E Titel - Beschluss und ToDo", status: "-", dueDate: null, longtext: "Fachfall E fuer die unabhaengigen Kennzeichnungen.", important: false, task: true, decision: true, responsibleIndex: 5 }),
  Object.freeze({ key: "fach-e-top", parentKey: "fach-e-titel", title: "E TOP - Beschluss und ToDo", status: "-", dueDate: null, longtext: "Fachfall E fuer einen normalen TOP.", important: false, task: true, decision: true, responsibleIndex: 5 }),
  Object.freeze({ key: "fach-f-titel", parentKey: null, title: "F Titel - Beschluss und ToDo ohne Ampel", status: "blockiert", dueDate: null, longtext: "Fachfall F belegt Beschluss und ToDo bei gleichzeitig unterdrueckter Titel-Ampel.", important: false, task: true, decision: true, responsibleIndex: 6 }),
  Object.freeze({ key: "fach-f-top", parentKey: "fach-f-titel", title: "F TOP - Ampel, Beschluss und ToDo", status: "blockiert", dueDate: null, longtext: "Fachfall F fuer einen normalen TOP.", important: false, task: true, decision: true, responsibleIndex: 6 }),
  Object.freeze({ key: "fach-g-titel", parentKey: null, title: "G Titel - Wichtig, Beschluss und ToDo ohne Ampel", status: "blockiert", dueDate: null, longtext: "Fachfall G belegt roten Titeltext, Beschluss und ToDo bei gleichzeitig unterdrueckter Titel-Ampel.", important: true, task: true, decision: true, responsibleIndex: 7 }),
  Object.freeze({ key: "fach-g-top", parentKey: "fach-g-titel", title: "G TOP - Wichtig plus alle Symbole", status: "blockiert", dueDate: null, longtext: "Fachfall G fuer einen normalen TOP.", important: true, task: true, decision: true, responsibleIndex: 7 }),
]);
