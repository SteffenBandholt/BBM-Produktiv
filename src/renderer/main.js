...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Übergangs-/Altlogik: Overlay für Release-Hinweise bleibt lokal gekapselt,
  // bis ein späterer gemeinsamer UI-/Addon-Schnitt vorbereitet ist.
  // Manueller Test:
  ...
  // Übergangs-/Altlogik: bestehender Shell-Aufbau mit Sidebar/Header/Routing.
  // Die fachlich verdrahteten Navigationspfade bleiben bewusst in dieser Datei,
  // werden aber fuer Phase 2 sichtbar vom Bootstrap und von service-naher Logik getrennt.
  const initUiOld = () => {
  ...
  // Übergangslogik: neuer UI-Modus basiert derzeit weiter auf dem alten Shell-Aufbau
  // und schichtet nur konservative Beschriftungs-/Layout-Anpassungen darüber.
  const initUiNew = () => {
    initUiOld();
