...
const RESTARBEITEN_UI_ELEMENTS = Object.freeze([
  ...
  element("restarbeiten.filterbar.group.class", "Typ", "group", "layout", "restarbeiten.filterbar", 20, OPS.group),
  ...
  element("restarbeiten.record.itemClass", "Typ", "label", "status", "restarbeiten.record.numberColumn", 30, OPS.content),
  ...
  element("restarbeiten.editbox.meta.itemClass", "Typ", "field", "meta", "restarbeiten.editbox.text.short", 30, OPS.field),
  element("restarbeiten.editbox.meta.itemClass.label", "Typ", "label", "meta", "restarbeiten.editbox.meta.itemClass", 5, OPS.content),
