...
const elements = [
  ...
  m83Element({ id: "protokoll.edit.dictation.status", name: "Diktatstatus", type: "group", role: "layoutGroup", parentId: "protokoll.edit.text", order: 55, allowedOps: groupLayout, componentKind: "dictationStatus", baseline: { minWidth: 1, minHeight: 1 } }),
