...
const elements = [
  ...
  m83Element({ id: "protokoll.edit.dictation.status", name: "Diktatstatus", type: "group", role: "layoutGroup", parentId: "protokoll.edit.text", order: 55, allowedOps: groupLayout, componentKind: "dictationStatus", hasVisibleText: true, baseline: { minWidth: 1, minHeight: 1 } }),
  m83DomainButton({ id: "protokoll.edit.dictation.status.action.undo", name: "Rückgängig", parentId: "protokoll.edit.dictation.status", order: 56, actionKind: "dictationUndo", baseline: { minWidth: 1, minHeight: 1 } }),
