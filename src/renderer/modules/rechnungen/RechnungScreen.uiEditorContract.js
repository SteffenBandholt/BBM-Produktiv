...
const buttonReflowIdsByParent = Object.freeze({
  "rechnung.overview.header": Object.freeze(["rechnung.overview.title", "rechnung.overview.subtitle", "rechnung.overview.customers", "rechnung.overview.catalog", "rechnung.overview.new"]),
...
const baseElements = Object.freeze([
  ...
  action("rechnung.overview.customers", "Kunden", "rechnung.overview.header", 24, "openCustomerManagement"),
  action("rechnung.overview.catalog", "Leistungskatalog", "rechnung.overview.header", 25, "openServiceCatalog"),
  action("rechnung.overview.new", "Freie Rechnung", "rechnung.overview.header", 26, "createDraft"),
  ...
  area("rechnung.editor.editArea", "Feste Editbox-Zone", "rechnung.editor", 75, "editArea"),
  area("rechnung.editor.editCanvas", "Editbox-Canvas", "rechnung.editor.editArea", 76, "editCanvas"),
  group("rechnung.editor.positionEditor", "Feste Positions-Editbox", "rechnung.editor.editCanvas", 77, "inlinePositionEditor"),
  label("rechnung.editor.positionEditor.title.label", "Position bearbeiten", "rechnung.editor.positionEditor", 78, "fieldLabel", "fieldLabel"),
  field("rechnung.editor.positionType", "Positionstyp", "rechnung.editor.positionEditor", 79, "select"),
  field("rechnung.editor.positionShort", "Kurztext", "rechnung.editor.positionEditor", 80, "singleLineText"),
  field("rechnung.editor.positionLong", "Langtext", "rechnung.editor.positionEditor", 81, "multilineText"),
  group("rechnung.editor.positionQuantityBlock", "Menge mit Nachkommastellen", "rechnung.editor.positionEditor", 82, "quantityInput"),
  group("rechnung.editor.positionQuantityDecimals", "Nachkommastellen-Zähler", "rechnung.editor.positionQuantityBlock", 83, "decimalStepper"),
  label("rechnung.editor.positionQuantityDecimals.label", "Nachkommastellen Bezeichnung", "rechnung.editor.positionQuantityDecimals", 84, "fieldLabel", "fieldLabel"),
  action("rechnung.editor.positionQuantityDecimals.decrease", "Nachkommastellen verringern", "rechnung.editor.positionQuantityDecimals", 85, "decreaseQuantityDecimalPlaces"),
  label("rechnung.editor.positionQuantityDecimals.value", "Nachkommastellen Wert", "rechnung.editor.positionQuantityDecimals", 86, "status", "counter"),
  action("rechnung.editor.positionQuantityDecimals.increase", "Nachkommastellen erhöhen", "rechnung.editor.positionQuantityDecimals", 87, "increaseQuantityDecimalPlaces"),
  field("rechnung.editor.positionQuantity", "Menge", "rechnung.editor.positionQuantityBlock", 88, "decimal"),
  field("rechnung.editor.positionUnit", "Einheit", "rechnung.editor.positionEditor", 89, "singleLineText"),
  field("rechnung.editor.positionPrice", "Einzelpreis", "rechnung.editor.positionEditor", 90, "currency"),
  field("rechnung.editor.positionVatRate", "MwSt.-Satz", "rechnung.editor.positionEditor", 91, "readOnlyText"),
  field("rechnung.editor.positionPriceGross", "Bruttoeingabe", "rechnung.editor.positionEditor", 92, "checkbox"),
  field("rechnung.editor.positionNep", "NEP", "rechnung.editor.positionEditor", 93, "checkbox"),
  group("rechnung.editor.positionActions", "Positionsaktionen", "rechnung.editor.positionEditor", 94, "actionGroup"),
  action("rechnung.editor.positionCreateTitle", "Titel neu", "rechnung.editor.positionActions", 95, "createHeading"),
  action("rechnung.editor.positionCreate", "Position neu", "rechnung.editor.positionActions", 96, "createPosition"),
  action("rechnung.editor.positionMove", "Position schieben", "rechnung.editor.positionActions", 97, "movePosition"),
  action("rechnung.editor.positionMoveRoot", "Auf Ebene 0 verschieben", "rechnung.editor.positionActions", 98, "movePositionToRoot"),
  action("rechnung.editor.positionDelete", "Position löschen", "rechnung.editor.positionActions", 99, "deletePosition"),
  group("rechnung.editor.editboxTotals", "Gesamtbetrag in der Editbox", "rechnung.editor.positionEditor", 100, "compactInvoiceTotals"),
  label("rechnung.editor.editboxTotals.title", "Gesamtbetrag Überschrift", "rechnung.editor.editboxTotals", 101),
  label("rechnung.editor.editboxTotals.netLabel", "Netto Bezeichnung", "rechnung.editor.editboxTotals", 102, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.netValue", "Netto Betrag", "rechnung.editor.editboxTotals", 103, "content", "amount"),
  label("rechnung.editor.editboxTotals.vatLabel", "Mehrwertsteuer Bezeichnung", "rechnung.editor.editboxTotals", 104, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.vatValue", "Mehrwertsteuer Betrag", "rechnung.editor.editboxTotals", 105, "content", "amount"),
  label("rechnung.editor.editboxTotals.grossLabel", "Brutto Bezeichnung", "rechnung.editor.editboxTotals", 106, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.grossValue", "Brutto Betrag", "rechnung.editor.editboxTotals", 107, "content", "amount"),
  group("rechnung.editor.payment", "Summen und Zahlungstext", "rechnung.editor.body", 108, "invoiceTotals"),
