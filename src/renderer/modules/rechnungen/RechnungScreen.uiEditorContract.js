...
const baseElements = Object.freeze([
  ...
  group("rechnung.editor.positionQuantityDecimals", "Nachkommastellen-Zähler", "rechnung.editor.positionQuantityBlock", 79.1, "decimalStepper"),
  label("rechnung.editor.positionQuantityDecimals.label", "Nachkommastellen Bezeichnung", "rechnung.editor.positionQuantityDecimals", 79.2, "fieldLabel", "fieldLabel"),
  action("rechnung.editor.positionQuantityDecimals.decrease", "Nachkommastellen verringern", "rechnung.editor.positionQuantityDecimals", 79.3, "decreaseQuantityDecimalPlaces"),
  label("rechnung.editor.positionQuantityDecimals.value", "Nachkommastellen Wert", "rechnung.editor.positionQuantityDecimals", 79.4, "status", "counter"),
  action("rechnung.editor.positionQuantityDecimals.increase", "Nachkommastellen erhöhen", "rechnung.editor.positionQuantityDecimals", 79.5, "increaseQuantityDecimalPlaces"),
  field("rechnung.editor.positionQuantity", "Menge", "rechnung.editor.positionQuantityBlock", 79.6, "decimal"),
  ...
  label("rechnung.editor.editboxTotals.title", "Gesamtbetrag Überschrift", "rechnung.editor.editboxTotals", 89.1),
  label("rechnung.editor.editboxTotals.netLabel", "Netto Bezeichnung", "rechnung.editor.editboxTotals", 89.2, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.netValue", "Netto Betrag", "rechnung.editor.editboxTotals", 89.3, "content", "amount"),
  label("rechnung.editor.editboxTotals.vatLabel", "Mehrwertsteuer Bezeichnung", "rechnung.editor.editboxTotals", 89.4, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.vatValue", "Mehrwertsteuer Betrag", "rechnung.editor.editboxTotals", 89.5, "content", "amount"),
  label("rechnung.editor.editboxTotals.grossLabel", "Brutto Bezeichnung", "rechnung.editor.editboxTotals", 89.6, "fieldLabel", "fieldLabel"),
  label("rechnung.editor.editboxTotals.grossValue", "Brutto Betrag", "rechnung.editor.editboxTotals", 89.7, "content", "amount"),
