export function injectCoreShellBaseStyles() {
  ...
  themeStyle.textContent = `
    :root {
      ...
      --bbm-form-control-padding-y: 5px;
      --bbm-form-control-padding-x: 8px;
      --bbm-form-label-font-size: 11.5px;
      --bbm-form-control-font-size: 12.5px;
      --bbm-form-control-font-size-sm: 11.5px;
      --bbm-form-textarea-height: 78px;
      --bbm-form-section-margin-top: 4px;
      --bbm-form-section-padding-y: 6px;
      --bbm-form-section-padding-x: 8px;
      --bbm-form-section-gap: 2px;
      --bbm-form-section-font-size: 11.5px;
      --bbm-form-section-status-height: 14px;
      --bbm-form-footer-padding-y: 8px;
      --bbm-form-footer-padding-x: 12px;
      --bbm-form-footer-gap: 6px;
      --bbm-form-button-height: 26px;
      --bbm-form-button-padding-y: 3px;
      --bbm-form-button-padding-x: 9px;
      --bbm-form-button-font-size: 12px;
