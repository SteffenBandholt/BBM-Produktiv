...
contextBridge.exposeInMainWorld("bbmDb", {
  ...
  sigekoPreviewPreNotificationPdf: (payload) => ipcRenderer.invoke("sigeko:previewPreNotificationPdf", payload),
  sigekoCreatePreNotificationPdf: (payload) => ipcRenderer.invoke("sigeko:createPreNotificationPdf", payload),
  sigekoListPreNotificationDocuments: (payload) => ipcRenderer.invoke("sigeko:listPreNotificationDocuments", payload),
  sigekoOpenPreNotificationDocumentFile: (payload) => ipcRenderer.invoke("sigeko:openPreNotificationDocumentFile", payload),
  sigekoPreparePreNotificationPdfEditor: (payload) => ipcRenderer.invoke("sigeko:preparePreNotificationPdfEditor", payload),
    sigekoGetPreNotificationRecipients: (payload) => ipcRenderer.invoke("sigeko:getPreNotificationRecipients", payload),
    sigekoSavePreNotificationRecipients: (payload) => ipcRenderer.invoke("sigeko:savePreNotificationRecipients", payload),
    sigekoGetPreNotificationCompletion: (payload) => ipcRenderer.invoke("sigeko:getPreNotificationCompletion", payload),
    sigekoSavePreNotificationCompletion: (payload) => ipcRenderer.invoke("sigeko:savePreNotificationCompletion", payload),
    sigekoOpenSimplePreNotificationMail: (payload) => ipcRenderer.invoke("sigeko:openSimplePreNotificationMail", payload),
  sigekoGetPreNotificationWorkflow: (payload) => ipcRenderer.invoke("sigeko:getPreNotificationWorkflow", payload),
  sigekoPreparePreNotificationMail: (payload) => ipcRenderer.invoke("sigeko:preparePreNotificationMail", payload),
  sigekoImportPreNotificationSignedReturn: (payload) => ipcRenderer.invoke("sigeko:importPreNotificationSignedReturn", payload),
  sigekoOpenPreNotificationSignedReturn: (payload) => ipcRenderer.invoke("sigeko:openPreNotificationSignedReturn", payload),
  sigekoOpenPreNotificationMailDraft: (payload) => ipcRenderer.invoke("sigeko:openPreNotificationMailDraft", payload),
  ...
  rechnungCreateDraftFromOrder: (data) => ipcRenderer.invoke("rechnung:createDraftFromOrder", data),
  ...
  rechnungFinalizePdf: (id) => ipcRenderer.invoke("rechnung:finalizePdf", { id }),
...
contextBridge.exposeInMainWorld("uiEditor", Object.freeze({
  ...
  getPdfDocumentTypeStatus: (context) => ipcRenderer.invoke("uiEditor:getPdfDocumentTypeStatus", _uiEditorPayload(context, "PDF-Dokumenttypabfrage")),
  registerPdfDocumentType: (context) => ipcRenderer.invoke("uiEditor:registerPdfDocumentType", _uiEditorPayload(context, "PDF-Dokumenttypregistrierung")),
