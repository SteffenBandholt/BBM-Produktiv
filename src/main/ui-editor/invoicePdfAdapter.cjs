...
const ELEMENTS = Object.freeze([
  ...
  element({ id: `${SCOPE_ID}.header`, name: "Rechnungskopf", parentId: `${SCOPE_ID}.page-template`, kind: "header", role: "layout", pageArea: "header", order: 20, capabilities: ["setVisibility"], baseline: box(12, 5, 186, 51), layoutBounds: HEADER_BOUNDS, refKey: "invoice.header", rendererKey: ".v2GlobalHeaderBlock,.v2HeaderFull,.v2HeaderMini" }),
  element({ id: `${SCOPE_ID}.body`, name: "Rechnungsinhalt", parentId: `${SCOPE_ID}.page-template`, kind: "area", role: "layout", order: 25, baseline: box(12, 56, 186, 215), layoutBounds: BODY_BOUNDS, refKey: "invoice.body", rendererKey: ".v2PageBody" }),
  element({ id: `${SCOPE_ID}.recipient`, name: "Rechnungsempfänger", parentId: `${SCOPE_ID}.body`, kind: "group", role: "content", order: 30, capabilities: ["setVisibility"], baseline: box(12, 56, 92, 31), layoutBounds: BODY_BOUNDS, refKey: "invoice.recipient", rendererKey: ".invoicePdfRecipient" }),
  element({ id: `${SCOPE_ID}.meta`, name: "Rechnungsdaten", parentId: `${SCOPE_ID}.body`, kind: "group", role: "meta", order: 40, capabilities: ["setVisibility"], baseline: box(108, 56, 90, 31), layoutBounds: BODY_BOUNDS, refKey: "invoice.meta", rendererKey: ".invoicePdfMeta" }),
  element({ id: `${SCOPE_ID}.meta.label`, name: "Rechnungsdaten-Bezeichnung", parentId: `${SCOPE_ID}.meta`, kind: "label", role: "fieldLabel", order: 41, baseline: box(108, 56, 32, 31), layoutBounds: BODY_BOUNDS, refKey: "invoice.meta.label", rendererKey: ".invoicePdfMetaLabel" }),
  element({ id: `${SCOPE_ID}.meta.value`, name: "Rechnungsdaten-Wert", parentId: `${SCOPE_ID}.meta`, kind: "value", role: "content", order: 42, baseline: box(140, 56, 58, 31), layoutBounds: BODY_BOUNDS, refKey: "invoice.meta.value", rendererKey: ".invoicePdfMetaValue" }),
  element({ id: `${SCOPE_ID}.intro`, name: "Einleitung", parentId: `${SCOPE_ID}.body`, kind: "text", role: "content", order: 50, capabilities: ["setVisibility"], baseline: box(12, 88, 186, 7), layoutBounds: BODY_BOUNDS, refKey: "invoice.intro", rendererKey: ".invoicePdfIntro" }),
