...
- M29 Restarbeiten-Filterleiste neu gegliedert und kompakter angeordnet:
  ...
  - Verortungsfilter sind als zwei Zweiergruppen aufgebaut (Level 1+2, Level 3+4) und die Label-Logik bleibt projektbezogen unver�ndert.
  ...
  - Schlie�en bleibt als eigener rechter Aktionsbereich in der Filterleiste.
...
- Das globale Fachwörterbuch V1 fuer das Diktat ist jetzt technisch angebunden:
  ...
  - der alte Projekt-Prompt zur Korrektur-Übernahme ist aus dem aktiven Flow entfernt
