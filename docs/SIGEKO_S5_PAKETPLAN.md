...
3. S5.3a abgeschlossen (PR #336, 1841/97, Windows/Linux Formular und PDF PASS): gemeinsamer Druckkontext und expliziter Modulzugang zur bestehenden Firmenliste. S5.3b1 abgeschlossen (PR #337, 1858/97, Windows/Linux PASS): interner unveränderlicher Snapshotvertrag ohne vorläufige Datenbankfassung. S5.3b2 abgeschlossen (PR #338, 1947/97, Windows/Linux PDF und Formular PASS): tatsächliche PDF-Erzeugung mit gemeinsamem V2-Kopf/PrintShell, 81 expliziten PDF-Zielen, Vorschau, finaler unveränderlicher Snapshot-/Dateipersistenz und V8-Projekttransfer. Native Windows-Editoröffnung und Reiterwahl nachgewiesen; ausführliche Grenzen und Reparaturen in SIGEKO_S5_3B2_ABNAHME.md.
4. S5.4 umgesetzt, tatsächliche Outlook-COM-Abnahme gemäß B6 bestanden: Steffens isolierter Nutzerlauf `C1ZLBX` auf Reparaturstand `d0662ac` endet mit PASS. Beide Entwürfe/PDF-Anhänge manuell bestätigt, nativer Rücklaufdialog, gespeichertes Grün nach DB-Reopen und neue unabhängige rote Fassung geprüft. Vorherige PDF-Vorbereitung `xVk60y` ebenfalls PASS. Alle zehn Windows-Schrift-/Skalierungskombinationen und Windows/Linux-PDF-Abnahme einschließlich 49 unveränderter Golden-Strukturen grün. Allgemeine npm-CI bleibt separat rot; vollständiger aktueller Vergleich mit vorgesehenem Kit: 2030/97 → 2040/97, exakt gleiche Fehler und keine verlorenen PASS. Unterbrechung/Wiederholung einzelner Gruppen ist im neuen Reparatur-Testvergleich dokumentiert. Integrationsnachweis in SIGEKO_S5_4_ABNAHME.md sowie PR #339/#274/#277. Die bestehende Integrationsfreigabe gilt weiter. Optionaler Kalenderanschluss bleibt S9.
