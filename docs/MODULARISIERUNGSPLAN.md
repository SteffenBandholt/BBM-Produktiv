...
- SurfaceInfo-Folgeschritte getrennt halten: G54 schliesst den G53-Stand als Referenz ab; sichtbar bleibt nur `restarbeiten.ui.main` kompakt read-only. PDF/Plan, weitere SurfaceIds, Auswahl, Bearbeitung, Drag, Resize und Persistenz bleiben eigene Folgepakete.
