...
- SurfaceInfo-Folgeschritte getrennt halten: G53 zeigt nur `restarbeiten.ui.main` kompakt read-only; PDF/Plan, weitere SurfaceIds, Auswahl, Bearbeitung, Drag, Resize und Persistenz bleiben eigene Folgepakete.
