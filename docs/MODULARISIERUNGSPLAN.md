...
- SurfaceInfo-/SurfaceSelection-Folgeschritte getrennt halten: G54 schliesst den G53-Stand als Referenz ab; G55 bereitet nur ein read-only Auswahlmodell vor. Sichtbar bleibt nur `restarbeiten.ui.main` kompakt read-only. PDF/Plan, weitere SurfaceIds, sichtbare Auswahl, Bearbeitung, Drag, Resize und Persistenz bleiben eigene Folgepakete.
